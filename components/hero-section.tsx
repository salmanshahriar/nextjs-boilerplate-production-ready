  ...
  const features = [
    {
      ...
      description: t("about.features.typeSafe"),
      details: [
    ...
    },
    {
      ...
      description: t("about.features.rbac"),
      details: ["User & Admin roles", "Protected routes", "Parallel routes"],
    },
    {
      icon: "🚀",
      title: "Next.js + TypeScript + Tailwind",
      description: t("about.features.stack"),
      details: ["Next.js 15", "TypeScript", "Tailwind CSS + shadcn/ui"],
    },
    {
      icon: "🎨",
      title: "Theme & Design",
      description: t("about.features.ui-experience"),
